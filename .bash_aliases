...
if [[ x"$OS" != x"Windows_NT" ]]; then alias c='cd /sd'; alias sd='cd /sd'; alias q=exit; fi;
...
alias ken-make='make CFLAGS_signal.o=-Og CFLAGS_signal.o=-Og CFLAGS_watchdog.o=-O0'
...
alias vi=vim
alias kvm-mergeconf='sh scripts/kconfig/merge_config.sh -m .config /root/github-conf/kvm_guest.conf'
